              ...
              <div className="text-center mb-8">
                ...
                <div className="flex justify-center items-center space-x-8 md:space-x-16">
                  ...
                  <div className="text-center">
                    <div className="relative">
                      <div
                        className={`w-32 h-32 md:w-48 md:h-48 rounded-full bg-gradient-to-br from-purple-400 to-pink-400 transition-all duration-1000 ${currentAvatar === 1 ? "scale-110 shadow-2xl shadow-purple-500/25" : "scale-100 shadow-lg"}`}
                      >
                        <img
                          src="/placeholder.svg?height=192&width=192"
                          alt="Future You"
