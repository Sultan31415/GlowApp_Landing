...
const GlowappLanding: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Button
              ...
              className="bg-gray-800 hover:bg-gray-900 text-white px-6 py-2 rounded-full transition-all duration-300 hover:scale-105"
            >
      ...
      {/* Hero Section */}
      <section id="hero" className="relative py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto text-center">
          {/* Central Logo */}
          <div className="mb-12">
            <div className="w-24 h-24 mx-auto bg-gray-800 rounded-2xl shadow-lg flex items-center justify-center mb-8 transition-all duration-500 hover:scale-110">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20">
              ...
              >
                Start Your Glowapp Journey
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="border-gray-800 text-gray-800 hover:bg-gray-800 hover:text-white px-8 py-4 text-lg rounded-full transition-all duration-300 transform hover:scale-105"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Card
                key={index}
                className="bg-white border-0 shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
              >
                  ...
                  <div className="flex items-center text-sm">
                    <TrendingUp
                      className={`w-4 h-4 mr-1 ${
                        stat.trend.startsWith("+") ? "text-green-500" : "text-red-500 rotate-180"
                      }`}
                    />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Card
                key={index}
                className="bg-white border-0 shadow-sm hover:shadow-md transition-all duration-500 transform hover:-translate-y-2 group"
              >
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Choose Your Glowapp Style</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-12">
            {archetypes.map((archetype, index) => (
              <Card
                key={index}
                className="bg-white border-0 shadow-sm cursor-pointer hover:shadow-md transition-all duration-300 transform hover:scale-105 group"
              >
                ...
                <div className="flex justify-center items-center space-x-8 md:space-x-16">
                  <div className="text-center">
                    <div className="relative">
                      <div
                        className={`w-32 h-32 md:w-48 md:h-48 rounded-full bg-gradient-to-br from-gray-200 to-gray-300 transition-all duration-1000 ${
                          currentAvatar === 0 ? "scale-110 shadow-2xl" : "scale-100 shadow-lg"
                        }`}
                      >
                        <img
                  ...
                  <div className="text-center">
                    <div className="relative">
                      <div
                        className={`w-32 h-32 md:w-48 md:h-48 rounded-full bg-gradient-to-br from-purple-400 to-pink-400 transition-all duration-1000 ${
                          currentAvatar === 1 ? "scale-110 shadow-2xl shadow-purple-500/25" : "scale-100 shadow-lg"
                        }`}
                      >
                        <img
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Card className="max-w-2xl mx-auto mb-8 bg-white border-0 shadow-sm hover:shadow-md transition-all duration-300">
            <CardContent className="p-8">
            ...
            <div>
              <Card className="relative overflow-hidden bg-white border-0 shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-0">
                  <div className="aspect-[9/16] bg-gradient-to-br from-purple-900 to-pink-900 flex items-center justify-center relative">
                    <Play className="w-16 h-16 text-white opacity-80" />
                    <div className="absolute bottom-4 left-4 right-4 text-white">
                      <div className="text-sm font-bold mb-2">30-Day Glowapp</div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Glowapp Board</h2>
              ...
              >
                <CardContent className="p-6">
                  ...
                  <div className="bg-gradient-to-r from-green-100 to-emerald-100 rounded-lg p-4 mb-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-green-700">{user.improvement}</div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center items-center space-x-8 mb-16 opacity-60">
            ...
            <div className="text-2xl font-bold text-gray-400">WhatsApp</div>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="grid grid-cols-3 gap-8 items-center">
              ...
              <div className="flex justify-center">
                <div className="w-20 h-20 bg-white rounded-2xl shadow-lg flex items-center justify-center hover:shadow-xl transition-all duration-300 transform hover:scale-110">
              ...
              <div className="flex justify-center">
                <div className="w-24 h-24 bg-gray-900 rounded-2xl shadow-xl flex items-center justify-center hover:shadow-2xl transition-all duration-300 transform hover:scale-110">
            ...
            <Card className="bg-white border-0 shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-8">
                <div className="mb-6">
                  ...
                  {/* Mock Chart */}
                  <div className="h-48 bg-gray-50 rounded-lg flex items-end justify-center p-4 space-x-2">
                    {[20, 35, 45, 30, 55, 40, 65, 50, 70, 60, 80, 75].map((height, index) => (
                      <div
                        key={index}
                        className={`w-6 rounded-t transition-all duration-500 hover:scale-110 ${
                          index === 5 ? "bg-purple-600" : "bg-gray-300"
                        }`}
                        style={{ height: `${height}%` }}
                      />
                    ))}
      ...
      {/* Quiz Section */}
      <section id="quiz-section" className="py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6">
            <Button
              onClick={scrollToQuiz}
              size="lg"
              className="bg-purple-600 hover:bg-purple-700 text-white px-12 py-6 text-xl rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
